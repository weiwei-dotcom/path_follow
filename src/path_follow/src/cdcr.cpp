...
CDCR::CDCR():Node("path_follow")
{
    ...
    Eigen::Vector3d temp_control_point9;
    this->declare_parameter<std::double_t>("bspline_control_point9_x", 100.0);
    double bspline_control_point9_x = this->get_parameter("bspline_control_point9_x").as_double();
    this->declare_parameter<std::double_t>("bspline_control_point9_y", 1100.0);
    double bspline_control_point9_y = this->get_parameter("bspline_control_point9_y").as_double();
    this->declare_parameter<std::double_t>("bspline_control_point9_z", 100.0);
    double bspline_control_point9_z = this->get_parameter("bspline_control_point9_z").as_double();
    temp_control_point9 << bspline_control_point9_x, bspline_control_point9_y, bspline_control_point9_z;
    this->ctrl_points.col(9) = temp_control_point9; 
    
    Eigen::Vector3d temp_control_point10;
    this->declare_parameter<std::double_t>("bspline_control_point10_x", 110.0);
    double bspline_control_point10_x = this->get_parameter("bspline_control_point10_x").as_double();
    this->declare_parameter<std::double_t>("bspline_control_point10_y", 900.0);
    double bspline_control_point10_y = this->get_parameter("bspline_control_point10_y").as_double();
    this->declare_parameter<std::double_t>("bspline_control_point10_z", 110.0);
    double bspline_control_point10_z = this->get_parameter("bspline_control_point10_z").as_double();
    temp_control_point10 << bspline_control_point10_x, bspline_control_point10_y, bspline_control_point10_z;
    this->ctrl_points.col(10) = temp_control_point10; 
  
    Eigen::Vector3d temp_control_point11;
    this->declare_parameter<std::double_t>("bspline_control_point11_x", 100.0);
    double bspline_control_point11_x = this->get_parameter("bspline_control_point11_x").as_double();
    this->declare_parameter<std::double_t>("bspline_control_point11_y", 1100.0);
    double bspline_control_point11_y = this->get_parameter("bspline_control_point11_y").as_double();
    this->declare_parameter<std::double_t>("bspline_control_point11_z", 100.0);
    double bspline_control_point11_z = this->get_parameter("bspline_control_point11_z").as_double();
    temp_control_point11 << bspline_control_point11_x, bspline_control_point11_y, bspline_control_point11_z;
    this->ctrl_points.col(11) = temp_control_point11; 
